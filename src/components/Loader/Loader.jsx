  ...
  return (
    <div className="loader-container">
      <svg className="pl" viewBox="0 0 160 160" width="160px" height="160px" xmlns="http://www.w3.org/2000/svg">
        ...
        <g>
          {[...Array(8)].map((_, i) => (
            <polyline key={i} className="pl__tick" stroke="hsl(223,10%,90%)" points="0,2 0,14" transform={`rotate(${i * 45},0,0) translate(0,40)`} />
          ))}
        </g>
        <g mask="url(#mask1)">
          {[...Array(8)].map((_, i) => (
            <polyline key={i} className="pl__tick" stroke="hsl(223,90%,80%)" points="0,2 0,14" transform={`rotate(${i * 45},0,0) translate(0,40)`} />
          ))}
        </g>
        {/* Arrows */}
        <g>
